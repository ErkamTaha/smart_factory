...
class WebSocketManager:
    ...
    async def broadcast_device_status(self, device_id: str, status: str, details: Optional[Dict[str, Any]] = None):
    ...
    async def broadcast_system_alert(self, level: str, message: str, details: Optional[Dict[str, Any]] = None):
